...
const projectsData = [
  ...
  },
  {
    ...
    category: "Mobile Apps",
    image: FreelanceMate,
    description: "A mobile application developed specifically for freelancers to caluculate Hourly, Daily, Monthly and yearly income or earnings per project and clients. It also have other world class features.",
    technologies: ["React Native", "Firebase.js", "Jvascript", "Bare Css"],
    codeLink: "https://github.com/jay-bee270/Brainstorm-The-App",
    isMobile: true,
  },
]
